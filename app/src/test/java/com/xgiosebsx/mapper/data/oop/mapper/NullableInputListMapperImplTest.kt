...
class NullableInputListMapperImplTest {
    ...
    private val sut = NullableInputListMapperImpl(mapper)

    @Test
    fun `map should return empty list when input list is null`() {
        val actual = sut.map(null)
